...
def extracter(infile):
	#infile = "human-get-trimmed-trans-region-min-sequence_heavy_pro.txt"
	...
	for index,line in enumerate(reader):
		...
		#print line
			...
			#print FR1
			FR2 = SeqRecord(Seq(line[12]),id=line[0],description="%s-%s | %s"%(line[13],line[14],line[15]),name='FR2-'+line[0])
			#print FR2
			FR3 = SeqRecord(Seq(line[22]),id=line[0],description="%s-%s | %s"%(line[23],line[24],line[25]),name='FR3-'+line[0])
			#print FR3
			FR4 = SeqRecord(Seq(line[32]),id=line[0],description="%s-%s | %s"%(line[33],line[34],line[35]),name='FR4-'+line[0])
			#print FR4
			CDR1 = SeqRecord(Seq(line[6]),id=line[0],description="%s-%s | %s | %s | %s"%(line[7],line[8],line[9],line[10],line[11]),name='CDR1-'+line[0])
			
			CDR2 = SeqRecord(Seq(line[16]),id=line[0],description="%s-%s | %s | %s | %s"%(line[17],line[18],line[19],line[20],line[21]),name='CDR2-'+line[0])
			
			CDR3 = SeqRecord(Seq(line[26]),id=line[0],description="%s-%s | %s | %s | %s"%(line[27],line[28],line[29],line[30],line[31],),name='CDR3-'+line[0])
...
def main():
	...
	#infile = 'test.fasta'
	the_files = glob.glob("*heavy_CDR_pro.txt")
